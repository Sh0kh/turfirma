...
export default function LinksDelete({ id, refresh }) {
    ...
    const handleDelete = async () => {
        try {
            const response = await $api.delete(`/join/link/delete?id=${id}`)
    ...
    return (
        <>
            ...
            <Dialog open={open} handler={handleOpen}>
                <DialogHeader>Havolani o‘chirish</DialogHeader>
                <DialogBody>
                    Siz rostdan ham ushbu havolani o‘chirmoqchimisiz?
                </DialogBody>
                <DialogFooter>
