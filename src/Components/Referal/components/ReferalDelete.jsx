...
export default function ReferalDelete({ id, refresh }) {
    ...
    const handleDelete = async () => {
        try {
            const response = await $api.delete(`/referral/delete?id=${id}`)
    ...
    return (
        <>
            ...
            <Dialog open={open} handler={handleOpen}>
                <DialogHeader>Referalni o‘chirish</DialogHeader>
                <DialogBody>
                    Siz rostdan ham ushbu referalni o‘chirmoqchimisiz?
                </DialogBody>
                <DialogFooter>
